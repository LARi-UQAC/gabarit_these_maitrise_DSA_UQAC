...
Convert slides to images (see [Converting to Images](#converting-to-images)), then inspect for:
- Overlapping elements, text overflow, cut-off content
- Decorative lines sized for single-line titles but title wrapped to two lines
- Elements too close (< 0.3" gaps) or nearly touching
- Uneven gaps, insufficient margins (< 0.5")
