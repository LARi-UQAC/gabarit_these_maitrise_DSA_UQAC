...
**Default recommendation**: When in doubt, check the journal's author guidelines. Most biomedical journals use Vancouver or AMA style. Most engineering journals use IEEE style.
...
**Journal Articles:**
```
[1] A. A. Author, B. B. Author, and C. C. Author, "Title of article," Journal Name, vol. X, no. X, pp. XX-XX, Month Year. DOI: xx.xxxx
```

**Example:**
```
[1] J. D. Smith, A. B. Johnson, and C. D. Williams, "Effectiveness of cognitive behavioral therapy for anxiety disorders," JAMA Psychiatry, vol. 80, no. 5, pp. 456-464, May 2023. DOI: xx.xxxx
```

**Books:**
```
[2] A. A. Author, Book Title, Edition. City, State: Publisher, Year. DOI: xx.xxxx
```

**Conference Papers:**
```
[3] A. A. Author, "Paper title," in Proc. Conference Name, City, State, Year, pp. XX-XX. DOI: xx.xxxx
```

**Online Sources:**
```
[4] A. A. Author. "Title." Website. URL (accessed Mon. Day, Year). DOI: xx.xxxx
```
...
```
IEEE: A. A. Author, "Title," in Proc. Conf. Name, City, Year, pp. XX-XX. https://doi.org/xx.xxxx
```
