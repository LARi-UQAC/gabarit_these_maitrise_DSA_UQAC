...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
%% Membres du jury — ajouter autant de
%% \ajoutermembre{} que nécessaire
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\ajoutermembre{Nom1, Institution1, Président du jury}
\ajoutermembre{Nom2, Institution2, Membre externe}
\ajoutermembre{Nom3, Institution3, Membre interne}
\ajoutermembre{Nom4, Institution4, Directeur de recherche}
\ajoutermembre{Nom5, Institution5, Co-directeur de recherche}
